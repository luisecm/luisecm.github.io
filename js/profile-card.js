window.addEventListener("DOMContentLoaded", async function () {
  ...
  document.querySelectorAll(".stack-card").forEach(async function (el) {
    ...
    el.innerHTML = `
        <a href="${profileLink}" target="_blank" style="text-decoration: none; color: black; display: block; border-radius: 12px; padding: 16px; font-size: 14px; background: linear-gradient(135deg, rgb(135, 155, 227), rgb(24, 27, 186)); box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); transition: transform 0.2s ease-in-out;">
